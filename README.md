📚 ConectaLibros
ConectaLibros es una aplicación web de biblioteca virtual que permite explorar, visualizar y administrar libros de forma organizada. Su objetivo es promover el acceso libre y controlado
a contenidos literarios mediante una experiencia de usuario simple y moderna.
